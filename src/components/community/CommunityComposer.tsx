...
const TAG_OPTIONS = ["满改", "跑刀", "大金", "白给", "修脚", "高配", "性价比"];
  ...
  return (
    <div className="bg-white dark:bg-[#121214] border border-zinc-200 dark:border-zinc-800 rounded-3xl p-6 mb-6 shadow-sm animate-fade-in">
      <div className="flex items-center justify-between mb-5">
        <h3 className="text-lg font-black text-zinc-900 dark:text-white">发布帖子</h3>
        <button
          onClick={onClose}
      ...
      <button
        ...
        disabled={posting || uploading || !hasImage}
      ...
      >
        {uploading ? "上传图片中..." : posting ? "发布中..." : "发布"}
      </button>
    </div>
  );
}

...
import { Search, Edit3, Plus, X, Save, ArrowUpDown, Radio } from 'lucide-react';
    ...
    <header className="w-full flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4 relative z-30">
      <div className="relative w-full max-w-sm group">
        ...
        <input
          type="text"
          placeholder="搜索枪械配置..."
          className="w-full pl-11 pr-12 py-3 rounded-2xl bg-white border border-zinc-200/80 shadow-[0_2px_8px_rgba(0,0,0,0.04)] text-zinc-900 placeholder:text-zinc-400 focus:outline-none focus:ring-4 focus:ring-zinc-900/10 focus:border-zinc-300 transition duration-200 text-sm font-bold"
        />
      </div>

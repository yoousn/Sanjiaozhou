...
export const DENSITY_PRESETS: Array<{ label: string; value: UiDensityPreset; preferences: Pick<UiPreferences, 'cardSize' | 'cardMinHeight' | 'variantsPerPage' | 'gridColumns' | 'gridGap' | 'groupsPerPage'> }> = [
  { label: '紧凑浏览', value: 'compact', preferences: { cardSize: 'compact', cardMinHeight: 300, variantsPerPage: 4, gridColumns: 4, gridGap: 12, groupsPerPage: 16 } },
  { label: '标准管理', value: 'balanced', preferences: { cardSize: 'default', cardMinHeight: 330, variantsPerPage: 3, gridColumns: 4, gridGap: 16, groupsPerPage: 12 } },
  { label: '大卡展示', value: 'comfortable', preferences: { cardSize: 'roomy', cardMinHeight: 400, variantsPerPage: 2, gridColumns: 3, gridGap: 24, groupsPerPage: 8 } },
];
...
export const GROUPS_PER_PAGE_OPTIONS: UiPreferences['groupsPerPage'][] = [8, 12, 16, 20, 24];
